  ...
  const projects = [
    {
      ...
      description: 'A full-featured e-commerce platform built with React, Node.js, and MongoDB. Features include product catalog, shopping cart, user authentication, payment processing, and admin dashboard. Implemented responsive design for optimal viewing on all devices.',
    ...
    },
    {
      ...
      description: 'Advanced healthcare platform leveraging AI for medical diagnostics and patient management. Features include AI-powered symptom checker, patient monitoring, and healthcare provider dashboard.',
      role: 'Full Stack Developer',
    ...
    },
    {
      ...
      description: 'Blockchain-based gaming platform with NFT integration, decentralized economy, and immersive gameplay. Features include character NFTs, in-game marketplace, and blockchain transactions.',
    ...
    },
    {
      ...
      description: 'Interactive cocktail recipe application with smooth animations using GSAP. Features include cocktail discovery, recipe details, ingredient search, and user favorites.',
      role: 'Full Stack Developer',
    ...
    },
    {
      ...
      description: 'Comprehensive healthcare management system for hospitals and clinics. Features include patient management, appointment scheduling, and medical records.',
      role: 'Full Stack Developer',
    ...
    },
    {
      ...
      description: 'Advanced DeFi protocol for automated portfolio management and liquidity provision. Features include smart order routing and customizable pools.',
      role: 'Blockchain Developer',
    ...
    },
    {
      ...
      description: 'Platform combining blockchain technology with AI for synthetic asset creation and trading. Features include AI-powered market prediction and DeFi integration.',
    ...
    },
    {
      ...
      description: 'AI-powered chatbot with blockchain integration for secure conversations and data ownership. Features include NFT-based identity and encrypted messaging.',
    ...
    },
    {
      ...
      description: 'Premium NFT marketplace featuring exclusive digital art and collectibles. Features include auctions, bidding, and community features.',
      role: 'Blockchain Developer',
